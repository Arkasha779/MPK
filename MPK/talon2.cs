...
namespace MPK
{
    public partial class talon2 : Form
    {
        public talon2()
        {
            InitializeComponent();
        ...
        private void talon22_Load(object sender, EventArgs e)
        {
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {

            {
                if (listBox1.Text != "")
                {
                    ...
                    obj.InsertParagraph("Тип услуги: Установка программы." + " Программа: " + userMessage + ".");
                    obj.InsertParagraph("Дата Вашей записи: " + userMessage2 + ".");
